...
- **Pipe Wall Thickness Calculator**: A 5-tab wizard calculator for pressure design of straight pipe per ASME B31.3:2022 §304.1.2 (process piping), B31.4:2019 §403.2.1 (liquid pipelines), and B31.8:2022 §841.11 (gas transmission). Implements temperature-interpolated allowable stress from B31.3 Table A-1, thick-wall Lamé equation check, ASME B36.10M schedule selection with pass/fail, MAOP back-calculation, hoop stress utilisation, and Barlow thin-wall formula. Material database covers ASTM A106 A/B, A333 Gr. 6, A312 TP304/316/316L, and API 5L grades B/X42/X52/X60/X65/X70/X80. Located at `/calculators/pipe-wall-thickness`, listed under Piping Components.
