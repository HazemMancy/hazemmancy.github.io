...
- **Wizard-style UI**: Complex calculators (e.g., Restriction Orifice, Control Valve, Separator, Heat Exchanger, PRD/Flare Relief, Compressor, Pump Sizing) utilize multi-tab wizard interfaces for guided input and calculation flow.
