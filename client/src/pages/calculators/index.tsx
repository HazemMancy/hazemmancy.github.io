...
const calculators: CalculatorEntry[] = [
  ...
  {
    title: "Conventional Separator",
    description: "Production separator sizing for vertical and horizontal vessels. Supports 2-phase and 3-phase configurations with Souders-Brown gas capacity and liquid holdup design.",
    href: "/calculators/conventional-separator",
    icon: Container,
    category: "Equipment",
    categoryColor: "text-amber-400",
    tags: ["API 12J", "2-Phase/3-Phase", "Souders-Brown"],
    standards: ["API 12J", "GPSA"],
  },
  {
    title: "Two-Phase Separator",
    description: "Gas scrubber and inlet separator sizing per GPSA. Designed for gas-dominant service with droplet settling verification and slug accommodation.",
    href: "/calculators/two-phase-separator",
    icon: Container,
    category: "Equipment",
    categoryColor: "text-amber-400",
    tags: ["GPSA Sec 7", "Gas Scrubber", "Droplet Settling"],
    standards: ["GPSA", "API RP 14E"],
  },
  {
    title: "Flare KO Drum",
