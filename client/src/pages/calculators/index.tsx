...
const calculators: CalculatorEntry[] = [
  ...
  },
  {
    ...
    description: "Size restriction orifices for liquid and gas service per ISO 5167-2:2003. Reader-Harris/Gallagher Cd, ISO Annex D permanent loss, API 14E erosional velocity, ISA-RP75.23 cavitation assessment, multi-stage pressure distribution, and ISO Table 3 straight-pipe requirements.",
    href: "/calculators/restriction-orifice",
    icon: CircleDot,
    category: "Equipment",
    categoryColor: "text-amber-400",
    tags: ["ISO 5167-2", "API 14E", "Cavitation / Choked Flow", "Multi-Stage"],
    standards: ["ISO 5167-2:2003", "API RP 14E", "ISA-RP75.23", "Crane TP-410"],
  },
  {
    title: "Control Valve Sizing",
    description: "Cv sizing for liquid, gas, and steam service per IEC 60534-2-1 / ISA S75.01. Iterative Fp, FLP, xTP; liquid choked flow and FF factor; gas expansion factor Y; Kc cavitation assessment (IEC 60534-2-2); flashing and noise risk screening per IEC 60534-8-3.",
    href: "/calculators/control-valve",
    icon: Gauge,
    category: "Equipment",
    categoryColor: "text-amber-400",
    tags: ["IEC 60534-2-1", "Cavitation / Flashing", "Choked Flow", "Fp / FLP / xTP"],
    standards: ["IEC 60534-2-1", "IEC 60534-2-2", "IEC 60534-8-3", "ISA S75.01"],
  },
  {
    title: "Separator Sizing",
    description: "Unified separator sizing for production separators (API 12J), gas scrubbers, inlet separators, slug catchers, and test separators (GPSA Sec 7). Supports vertical/horizontal orientation and 2-phase/3-phase configurations with standard-based questionnaire.",
    href: "/calculators/separator-sizing",
    icon: Container,
    category: "Equipment",
    categoryColor: "text-amber-400",
    tags: ["API 12J", "GPSA Sec 7", "2-Phase/3-Phase", "Souders-Brown"],
    standards: ["API 12J", "GPSA Sec 7", "API RP 14E"],
  },
  {
    title: "Flare Knock Out Drum Sizing",
    description: "Flare knockout drum sizing per API 521. Conservative K-factors for gravity settling with multi-scenario liquid accumulation and drain adequacy checks.",
    href: "/calculators/flare-ko-drum",
    icon: Flame,
    category: "Equipment",
    categoryColor: "text-amber-400",
    tags: ["API 521", "Conservative K", "Transient Loads"],
    standards: ["API 521", "API 12J"],
  },
  {
