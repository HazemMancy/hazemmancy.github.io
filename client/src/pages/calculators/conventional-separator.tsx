...
const TABS = [
  ...
  { id: "config", label: "Design", icon: Settings2, step: 3, desc: "Orientation, phase mode & K-value" },
      ...
      <Tabs value={activeTab} onValueChange={setActiveTab} className="space-y-0">
        ...
        <TabsContent value="project">
          <div className="space-y-4">
            <StepHeader step={1} title="Project Setup" desc="Enter project info and calculation options." />
          <Card>
        ...
        <TabsContent value="cases">
          <div className="space-y-4">
            <StepHeader step={2} title="Operating Cases" desc="Define operating case data for each scenario." />
          <Card>
            <CardHeader className="pb-3">
        ...
        <TabsContent value="config">
          <div className="space-y-4">
            <StepHeader step={3} title="Design Basis" desc="Set orientation, phase mode & K-value." />
        ...
        <TabsContent value="gas">
          <div className="space-y-4">
            <StepHeader step={4} title="Gas Capacity Sizing" desc="Souders-Brown gas capacity results." />
          {!result ? (
        ...
        <TabsContent value="holdup">
          <div className="space-y-4">
            <StepHeader step={5} title="Liquid Holdup & Surge" desc="Define liquid residence and surge time requirements." />
          <Card>
            <CardHeader className="pb-3">
        ...
        <TabsContent value="geometry">
          <div className="space-y-4">
            <StepHeader step={6} title="Geometry Assembly" desc="Vessel dimensions & L/D ratio checks." />
          {!result ? (
            <Card><CardContent className="py-12 text-center">
        ...
        <TabsContent value="results">
          <div className="space-y-4">
            <StepHeader step={7} title="Results Summary" desc="Review results, flags & export." />
          {!result ? (
            <Card><CardContent className="py-12 text-center">
